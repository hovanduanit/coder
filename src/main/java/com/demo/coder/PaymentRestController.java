...
public class PaymentRestController {
    ...
    public PaymentRestController(PaymentMethodRepository paymentMethodRepository) {
    ...
    static class AddPaymentMethodRequest {
        private String paymentMethodId;
    ...
    public ResponseEntity<String> handleWebhook(@RequestHeader("Stripe-Signature") String sigHeader, @RequestBody String payload) {
        ...
        try {
            ...
            return status(HttpStatus.BAD_REQUEST).body("Invalid signature");
        } catch (Exception e) {
            return status(HttpStatus.BAD_REQUEST).body("Error processing webhook");
        }
...
//                }
    ...
    public ResponseEntity<Map<String, Object>> createPaymentIntentForExistingCustomer(@RequestBody PaymentRequest request) {
...
//            }
    ...
    public ResponseEntity<ApiResponse> addPaymentMethod(@RequestBody AddPaymentMethodRequest request) {
        Map<String, Object> response = new HashMap<>();
        try {
...
//            String email = request.get("email");
            ...
            return ResponseEntity.ok(new ApiResponse("success", "Payment method added successfully."));
        } catch (StripeException e) {
    ...
    public ResponseEntity<ApiResponse>  removePaymentMethod(@RequestBody PaymentRequest paymentRequest) throws StripeException {
        ...
        return ResponseEntity.ok(new ApiResponse("success", "Payment method removed successfully."));
